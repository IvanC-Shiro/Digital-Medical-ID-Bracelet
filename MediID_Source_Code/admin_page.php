  ...
  <div class="panel-group" id="accordion">
    ...
    <div class="panel panel-default">
      ...
      <div id="collapse2" class="panel-collapse collapse">
        <div class="panel-body"><?php echo "Provider: ". $insurancei["provider"]; echo "<br>Group Number: ". $insurancei["groupNumber"]; echo "<br>Member Number: ". $insurancei["memberNumber"]; echo "<br>Date of Expiration: ". $insurancei["expirationDate"]; ?></div>
      </div>
    </div>
    <div class="panel panel-default">
      <div class="panel-heading">
      ...
      <div id="collapse3" class="panel-collapse collapse">
        <div class="panel-body"><?php foreach($arrm as $item){echo "<li>" . $item ;} ?></div>
      </div>
    </div>
    <div class="panel panel-default">
      <div class="panel-heading">
      ...
      <div id="collapse5" class="panel-collapse collapse">
        <div class="panel-body"><?php foreach($arr1 as $item){echo "<li>" . $item ;} ?></div>
      </div>
    </div>
    <div class="panel panel-default">
      <div class="panel-heading">
      ...
      <div id="collapse4" class="panel-collapse collapse">
        <div class="panel-body"><?php foreach($asd as $item){echo "<li>" . $item ;} ?></div>
      </div>
    </div>  
    </div>
  </div> 
...
<div class="container">
   ...
   <div class="content">
      <a href="logoutEMT.php" class="btn">logout</a>
   </div>
